...
const EVENT_MAP: Record<string, Partial<ResolvedNotificationAction>> = {
  ...
  proxy_proof_poster_approved: { actionType: "GENERIC_NAV", targetUrl: "/admin/missions", overlay: "none", ctaLabel: "Release or refund" },
  proxy_refund_requested: { actionType: "GENERIC_NAV", targetUrl: "/admin/missions", overlay: "none", ctaLabel: "Acknowledge & refund" },
  proxy_escrow_refunded: { actionType: "GENERIC_NAV", targetUrl: "/advocate/proxy", overlay: "none", ctaLabel: "Open Proxy Hub" },
  ...
  proxy_mission_assigned: { actionType: "GENERIC_NAV", targetUrl: "/advocate/proxy", overlay: "none", ctaLabel: "Accept mission" },
  proxy_mission_accepted: { actionType: "GENERIC_NAV", targetUrl: "/advocate/proxy", overlay: "none", ctaLabel: "Open Proxy Hub" },
