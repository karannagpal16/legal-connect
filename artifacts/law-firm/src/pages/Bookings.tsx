                ...
                {booking.status === "Confirmed" && (
                  <>
                    <button 
                      ...
                      className="col-span-2 py-2.5 rounded-xl bg-green-600 hover:bg-green-700 text-white text-sm font-bold flex items-center justify-center gap-2 transition-colors shadow-md shadow-green-900/20"
                    >
