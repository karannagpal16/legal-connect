...
import {
  ...
  Gavel, Search, ExternalLink, RefreshCw, Hash, User, FileSearch,
  FileText, Loader2, X, ListOrdered, Eye, Scale, Landmark, Building2,
...
type CourtLevel = "all" | "district" | "high" | "supreme";
...
const firmCases: Case[] = [
  {
    ...
    filingDate: "Sep 3, 2025",
    synced: true,
    lastSyncTime: "Today, 9:14 AM",
    steps: [
      ...
      { id: "s2", title: "Legal Notice Sent", desc: "Notice sent to landlord via registered post", date: "Sep 10, 2025", status: "done" },
      ...
      { id: "s5", title: "Evidence (In Progress)", desc: "Examination of witnesses and document submission", date: "Apr 12, 2026", status: "active", note: "Client must be present. Original docs needed." },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s2", title: "Complaint Filed", desc: "Filed at District Consumer Forum, West Delhi", date: "Feb 12, 2026", status: "done" },
      { id: "s3", title: "Admission Hearing", desc: "Forum will decide whether to admit the complaint", date: "Apr 22, 2026", status: "active" },
      ...
      { id: "s6", title: "Final Order", desc: "Consumer Forum pronounces order with compensation", status: "pending" },
    ],
  },
  {
    id: "ac3",
    ...
    lastSyncTime: "Today, 9:14 AM",
    steps: [
      { id: "s1", title: "FIR Registered", desc: "FIR 221/2025 at PS Rajouri Garden", date: "Nov 20, 2025", status: "done" },
      { id: "s2", title: "Investigation", desc: "Police investigation and evidence collection", date: "Dec 2025 – Feb 2026", status: "done" },
      { id: "s3", title: "Charge-sheet Filed", desc: "Police filed final report in court", date: "Mar 10, 2026", status: "done" },
      { id: "s4", title: "Arguments on Charge", desc: "Court to decide whether to frame charges", date: "Apr 18, 2026", status: "active" },
      ...
      { id: "s8", title: "Final Arguments", desc: "Both sides present closing arguments", status: "pending" },
      { id: "s9", title: "Judgement", desc: "Court pronounces verdict", status: "pending" },
    ],
  },
  {
    id: "ac4",
    title: "Priya Sharma vs. Amit Sharma — Mutual Consent Divorce",
    caseNo: "HMA/DJ-S/2026/0312",
    cnr: "DLSKT04-000312-2026",
    court: "Family Court, Saket, Delhi",
    courtLevel: "district",
    assignedTo: "Adv. Arjun Mehta",
    type: "family",
    typeLabel: "Family — HMA S.13B",
    petitioner: "Priya Sharma",
    respondent: "Amit Sharma",
    nextDate: "May 5, 2026",
    nextHearing: "Second Motion (6 months cooling period ends)",
    urgency: "low",
    lastOrder: "First motion recorded. Cooling period commenced.",
    lastOrderDate: "Nov 5, 2025",
    filingDate: "Nov 5, 2025",
    synced: true,
    lastSyncTime: "Today, 9:14 AM",
    steps: [
      { id: "s1", title: "Petition Filed", desc: "Mutual consent petition under HMA S.13B", date: "Nov 5, 2025", status: "done" },
      { id: "s2", title: "First Motion", desc: "Joint statement recorded", date: "Nov 5, 2025", status: "done" },
      { id: "s3", title: "Cooling Period", desc: "6-month mandatory wait", date: "Nov 2025 – May 2026", status: "active" },
  ...
  {
    id: "ac5",
    title: "Sunita Devi vs. ABC Manufacturing — Wrongful Termination",
    caseNo: "ID/LC-C/2026/0078",
    cnr: "DLLC05-000078-2026",
    court: "Labour Court, Central Delhi",
    courtLevel: "district",
    assignedTo: "Adv. Vikram Bose",
    type: "labour",
    typeLabel: "Labour — Industrial Disputes Act",
    petitioner: "Sunita Devi (Worker)",
    respondent: "ABC Manufacturing Ltd.",
    nextDate: "Apr 28, 2026",
    nextHearing: "Written Statement by Management",
    urgency: "medium",
    lastOrder: "Claim statement filed. Notice issued to management.",
    lastOrderDate: "Mar 1, 2026",
    filingDate: "Feb 15, 2026",
    synced: true,
    lastSyncTime: "Today, 9:14 AM",
    steps: [
      { id: "s1", title: "Reference Filed", desc: "Dispute referred to Labour Court", date: "Feb 15, 2026", status: "done" },
      { id: "s2", title: "Claim Statement", desc: "Worker's statement of claim filed", date: "Mar 1, 2026", status: "done" },
      { id: "s3", title: "Management Reply", desc: "Company to file written statement", date: "Apr 28, 2026", status: "active" },
      { id: "s4", title: "Evidence", desc: "Both sides produce evidence", status: "pending" },
      { id: "s5", title: "Arguments & Award", desc: "Final arguments and Labour Court award", status: "pending" },
    ],
  },
  {
    id: "ac6",
    title: "Land Acquisition Challenge — NH-44 Widening",
    ...
    urgency: "high",
    lastOrder: "Writ petition admitted. Notice issued to respondents. Stay on demolition till next date.",
    lastOrderDate: "Mar 28, 2026",
    filingDate: "Mar 20, 2026",
    synced: true,
    lastSyncTime: "Today, 9:14 AM",
    steps: [
      { id: "s1", title: "Petition Filed", desc: "Writ petition under Art 226 filed before Delhi HC", date: "Mar 20, 2026", status: "done" },
      { id: "s2", title: "Urgent Listing", desc: "Matter listed for urgent hearing", date: "Mar 28, 2026", status: "done" },
      { id: "s3", title: "Notice & Interim Stay", desc: "HC issues notice, grants interim stay on demolition", date: "Mar 28, 2026", status: "done" },
      { id: "s4", title: "Reply by Respondents", desc: "Union of India & NHAI to file counter affidavit", date: "May 2, 2026", status: "active" },
  ...
  {
    id: "ac7",
    title: "SLP — Municipal Tax Overcharge",
    caseNo: "SLP(C)/SCI/2026/8841",
    cnr: "SCSLP07-008841-2026",
    court: "Supreme Court of India",
    courtLevel: "supreme",
    assignedTo: "Adv. Rishika Nagpal",
    type: "civil",
    typeLabel: "SLP — Municipal Tax",
    petitioner: "Delhi Traders Association",
    respondent: "SDMC & MCD",
    nextDate: "May 15, 2026",
    nextHearing: "Admission Hearing",
    urgency: "medium",
    lastOrder: "SLP filed. Listed for admission before bench.",
    lastOrderDate: "Apr 2, 2026",
    filingDate: "Apr 1, 2026",
    synced: true,
    lastSyncTime: "Today, 9:14 AM",
    steps: [
      { id: "s1", title: "SLP Filed", desc: "Special Leave Petition filed before Supreme Court", date: "Apr 1, 2026", status: "done" },
      { id: "s2", title: "Defects Cured", desc: "Registry defects removed, case numbered", date: "Apr 2, 2026", status: "done" },
      { id: "s3", title: "Admission Hearing", desc: "Court to decide whether to admit the SLP", date: "May 15, 2026", status: "active" },
      { id: "s4", title: "Notice to Respondents", desc: "If admitted, notice issued to SDMC & MCD", status: "pending" },
      { id: "s5", title: "Counter Affidavit", desc: "Respondents to file counter", status: "pending" },
      { id: "s6", title: "Final Hearing", desc: "Arguments on merits", status: "pending" },
      { id: "s7", title: "Judgement", desc: "Supreme Court pronounces verdict", status: "pending" },
    ],
  },
];
...
const courtLevelConfig: Record<CourtLevel, { label: string }> = {
  all: { label: "All Courts" },
  district: { label: "District" },
  high: { label: "High Court" },
  supreme: { label: "Supreme Court" },
};
...
const urgencyConfig = {
  high: { label: "Urgent", color: "text-rose-400", bg: "bg-rose-500/10 border-rose-500/25", dot: "bg-rose-400" },
  medium: { label: "On Track", color: "text-amber-400", bg: "bg-amber-500/10 border-amber-500/25", dot: "bg-amber-400" },
  low: { label: "Settled", color: "text-emerald-400", bg: "bg-emerald-500/10 border-emerald-500/25", dot: "bg-emerald-400" },
};
...
export function AdvocateCaseTracker() {
  const [expandedCase, setExpandedCase] = useState<string>(firmCases[0].id);
  ...
  const filteredCases = firmCases.filter(c => {
    if (typeFilter !== "all" && c.type !== typeFilter) return false;
    if (courtFilter !== "all" && c.courtLevel !== courtFilter) return false;
  ...
  const totalActive = firmCases.length;
  const urgentCount = firmCases.filter(c => c.urgency === "high").length;
  const thisWeek = firmCases.filter(c => {
    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-serif font-bold text-white">Firm Case Tracker</h1>
            <p className="text-white/40 text-xs mt-0.5">All firm cases · eCourt synced · Real-time status</p>
          </div>
        </div>
        <button
          onClick={handleSync}
      ...
      {syncing && (
        <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} className="bg-primary/10 border border-primary/25 rounded-xl px-4 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white/40 text-[10px]">Pulling latest orders, cause lists, and case status from ecourts.gov.in</p>
          </div>
        </motion.div>
      )}

      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="bg-card/40 border border-white/10 rounded-xl p-4">
          <p className="text-white/25 text-[10px] uppercase tracking-wider font-bold">Active Cases</p>
          <p className="text-white text-2xl font-black mt-1">{totalActive}</p>
        </div>
        <div className="bg-card/40 border border-white/10 rounded-xl p-4">
          <p className="text-white/25 text-[10px] uppercase tracking-wider font-bold">Urgent</p>
          <p className="text-rose-400 text-2xl font-black mt-1">{urgentCount}</p>
        </div>
        <div className="bg-card/40 border border-white/10 rounded-xl p-4">
          <p className="text-white/25 text-[10px] uppercase tracking-wider font-bold">Hearings This Week</p>
        ...
        <div className="flex gap-2 flex-wrap">
          <div className="flex gap-1.5 overflow-x-auto scrollbar-hide">
            {(Object.keys(caseTypeConfig) as CaseType[]).map(ct => (
              <button key={ct} onClick={() => setTypeFilter(ct)} className={`flex-shrink-0 px-2.5 py-1.5 rounded-full text-[10px] font-bold transition-all border ${typeFilter === ct ? "bg-primary/15 border-primary/30 text-primary" : "bg-white/5 border-white/10 text-white/30 hover:text-white/50"}`}>
          ...
          <div className="flex gap-1.5">
            {(Object.keys(courtLevelConfig) as CourtLevel[]).map(cl => (
              <button key={cl} onClick={() => setCourtFilter(cl)} className={`flex-shrink-0 px-2.5 py-1.5 rounded-full text-[10px] font-bold transition-all border ${courtFilter === cl ? "bg-violet-500/15 border-violet-500/30 text-violet-400" : "bg-white/5 border-white/10 text-white/30 hover:text-white/50"}`}>
            ...
            {filteredCases.map(c => {
              ...
              return (
                <button key={c.id} onClick={() => setExpandedCase(c.id)} className={`text-left bg-card/40 border rounded-2xl p-4 transition-all ${isSelected ? "border-primary/40 bg-primary/5 ring-1 ring-primary/20" : "border-white/10 hover:border-white/20"}`}>
                  ...
                  <p className="text-white/35 text-[10px] mb-1">{c.court}</p>
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    <span className="text-[9px] text-white/20">· {c.assignedTo}</span>
                  </div>
            ...
            return (
              <motion.div key={c.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
                <div className="bg-card/40 border border-white/10 rounded-2xl p-5">
                  ...
                  {c.lastOrder && (
                    <div className="bg-blue-500/8 border border-blue-500/15 rounded-xl p-3 mb-4">
                  ...
                  {c.urgency === "high" && (
                    <div className="bg-rose-500/10 border border-rose-500/25 rounded-xl p-3 flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <p className="text-white/40 text-xs">{c.nextDate} · Prepare case file and brief</p>
                      </div>
                    </div>
                  )}
                </div>
