    ...
    <div className="space-y-10">
      <div>
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-3xl font-serif font-bold text-[#1A2332]">Skill Badges</h1>
        </div>
        <p className="text-[#1A2332]/40 ml-10">Earn badges by completing achievements and leveling up.</p>
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {earned.map((badge, i) => (
            ...
            >
              ...
              <h3 className="text-[#1A2332] font-bold text-sm mb-1">{badge.title}</h3>
              <p className="text-[#1A2332]/40 text-xs leading-relaxed mb-3">{badge.desc}</p>
              {badge.earnedAt && (
      ...
      {locked.length > 0 && (
        <div>
          <h2 className="text-xs font-semibold uppercase tracking-widest text-[#1A2332]/30 mb-4 flex items-center gap-2">
            <Lock className="w-4 h-4 text-[#1A2332]/30" />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {locked.map((badge, i) => (
              <motion.div
                ...
                className="bg-[#1A2332]/5 border border-[#1A2332]/10 rounded-2xl p-5 flex flex-col items-center text-center opacity-50"
              >
                <div className="text-4xl mb-3 grayscale">{badge.emoji}</div>
                <div className="w-5 h-5 rounded-full bg-[#1A2332]/10 flex items-center justify-center mb-2">
                  <Lock className="w-3 h-3 text-[#1A2332]/30" />
                </div>
                <h3 className="text-[#1A2332]/50 font-bold text-sm mb-1">{badge.title}</h3>
                <p className="text-[#1A2332]/20 text-xs leading-relaxed mb-3">{badge.desc}</p>
                <span className="text-[10px] text-[#1A2332]/30 bg-[#1A2332]/5 border border-[#1A2332]/10 px-2 py-0.5 rounded-full">
