  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 mb-1">
        ...
        <div>
          <h1 className="text-2xl font-serif font-bold text-[#1A2332]">My Advocate Chat</h1>
      ...
      <div className="bg-emerald-500/8 border border-emerald-500/20 rounded-2xl p-4 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[#1A2332]/40 text-xs mt-0.5">Only you and your advocate can read these messages. Encrypted with AES-256.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-card/40 border border-[#1A2332]/10 rounded-2xl p-5">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="text-[#1A2332] font-bold">Adv. Arjun Mehra</p>
                <p className="text-[#1A2332]/40 text-xs">Senior Advocate</p>
            ...
            <div className="space-y-2 text-xs text-[#1A2332]/40 mb-4">
              <div className="flex justify-between">
                <span>Court</span>
                <span className="text-[#1A2332]/70">Delhi HC & SC</span>
              </div>
              <div className="flex justify-between">
                <span>Specialisation</span>
                <span className="text-[#1A2332]/70">Criminal, Property</span>
              </div>
              <div className="flex justify-between">
                <span>Your case</span>
                <span className="text-[#1A2332]/70">Tenancy Dispute</span>
              </div>
            </div>
          ...
          <div className="bg-amber-500/8 border border-amber-500/20 rounded-2xl p-4">
            ...
            <p className="text-[#1A2332]/45 text-xs leading-relaxed">
        ...
        {/* Chat window */}
        <div className="lg:col-span-2 bg-card/40 border border-[#1A2332]/10 rounded-2xl flex flex-col h-[520px] overflow-hidden">
          <div className="px-5 py-3.5 border-b border-[#1A2332]/8 bg-[#1A2332]/5 flex items-center justify-between">
            <span className="text-[#1A2332]/50 text-xs font-semibold uppercase tracking-wider">Tenancy Dispute – Rohini Property</span>
            ...
            {conversation?.messages.map((msg) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`max-w-[78%] rounded-2xl px-4 py-3 ${isClient ? "bg-blue-500/15 border border-blue-500/20" : "bg-[#1A2332]/8 border border-[#1A2332]/10"}`}>
          ...
          <div className="px-4 py-4 border-t border-[#1A2332]/8">
            <div className="flex items-center gap-3 bg-[#1A2332]/5 border border-[#1A2332]/10 rounded-xl px-4 py-3 focus-within:border-blue-500/30">
              <input
                value={input}
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={handleSend}
                  disabled={!input.trim()}
                  className={`w-8 h-8 rounded-xl flex items-center justify-center transition-all ${input.trim() ? "bg-blue-500 text-[#1A2332] hover:bg-blue-600" : "bg-[#1A2332]/10 text-[#1A2332]/20"}`}
                >
