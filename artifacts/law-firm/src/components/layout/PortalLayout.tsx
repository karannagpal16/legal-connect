...
const navigation: Record<AppRole, NavItem[]> = {
  ...
  advocate: [
    ...
    { label: "LC Room", href: "/advocate/calls", icon: MessageSquareText },
    ...
    { label: "Earnings", href: "/advocate/revenue", icon: ReceiptIndianRupee },
  ...
  client: [
    ...
    { label: "LC Room", href: "/client/connect", icon: MessageSquareText },
