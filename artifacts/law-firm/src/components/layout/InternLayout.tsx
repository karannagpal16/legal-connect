      ...
      >
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "bg-[#CDA45E]/15" : "hover:bg-white/5"
                )}
                style={isActive ? { color: T, border: "1px solid rgba(205,164,94,0.32)" } : { color: M }}
              >
                {isActive && <motion.div layoutId="internActiveTab" className="absolute left-0 top-0 bottom-0 w-1 rounded-r-full" style={{ background: G }} />}
        ...
        <div className="p-6" style={{ borderTop: "1px solid rgba(205,164,94,0.22)" }}>
          <div className="flex items-center gap-3 px-3 py-3 rounded-xl lc-sidebar-card">
            <div className="w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm" style={{ background: "rgba(205,164,94,0.14)", color: E }}>
              L3
            </div>
            <div className="flex flex-col">
