...
const ACTION_TO_EVENT = Object.freeze({
  ...
  intake_lc_under_review: EVENT_TYPES.STATUS_UPDATE,
  ...
  case_update_pending_review: EVENT_TYPES.STATUS_UPDATE,
  case_update_approved: EVENT_TYPES.STAGE_ADVANCED_BY_ADVOCATE,
  case_update_returned: EVENT_TYPES.STATUS_UPDATE,
  intake_concluded: EVENT_TYPES.REQUEST_ENTERTAINED,
...
const NOTIFY_TO_EVENT = Object.freeze({
  ...
  intake_advocate_accepted: EVENT_TYPES.ADVOCATE_ACKNOWLEDGED,
  case_update_pending_review: EVENT_TYPES.STATUS_UPDATE,
  case_update_held_for_lc: EVENT_TYPES.STATUS_UPDATE,
  case_update_approved: EVENT_TYPES.STAGE_ADVANCED_BY_ADVOCATE,
  case_update_published: EVENT_TYPES.STAGE_ADVANCED_BY_ADVOCATE,
  case_reply_approved: EVENT_TYPES.STATUS_UPDATE,
  intake_concluded: EVENT_TYPES.REQUEST_ENTERTAINED,
  case_stage_updated: EVENT_TYPES.STAGE_ADVANCED_BY_ADVOCATE,
  booking_stage_updated: EVENT_TYPES.STAGE_ADVANCED_BY_ADVOCATE,
  proxy_mission_posted: EVENT_TYPES.PROXY_MISSION_POSTED,
