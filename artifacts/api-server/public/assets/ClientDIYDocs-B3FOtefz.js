<<<<<<<< HEAD:artifacts/api-server/public/assets/ClientDIYDocs-BDgg7PH2.js
import{r as n,j as e}from"./tanstack-query-BLUn7k_x.js";import{m as l,H as N,S as g,f as b,g as A,L as p,F as T}from"./index-DdCqXAB9.js";import{P as E}from"./pen-pt9kt_d1.js";import{C as u}from"./check-GjZ6yHvW.js";import{B as D}from"./briefcase-Cxu5HZRY.js";import{C as v,D as j}from"./download-D1teVc9g.js";const R=[{id:"rent",title:"Rent Agreement",icon:N,category:"Property",color:"text-blue-400",bg:"bg-blue-500/10 border-blue-500/20",desc:"Standard residential rent agreement between landlord and tenant.",fields:[{key:"landlordName",label:"Landlord's Full Name",placeholder:"Rajesh Kumar Sharma"},{key:"tenantName",label:"Tenant's Full Name",placeholder:"Amit Verma"},{key:"propertyAddress",label:"Property Address",placeholder:"C-42, Sector 15, Noida, UP 201301",multiline:!0},{key:"monthlyRent",label:"Monthly Rent (₹)",placeholder:"25000"},{key:"securityDeposit",label:"Security Deposit (₹)",placeholder:"50000"},{key:"startDate",label:"Lease Start Date",placeholder:"01/04/2026"},{key:"duration",label:"Lease Duration",placeholder:"11 months"}],template:t=>`RENT AGREEMENT
========
import{r as s,j as e}from"./tanstack-query-BLUn7k_x.js";import{c as y,m as l,t as m,H as N,S as g,E as A,L as b,F as T}from"./index-RJUN-bDg.js";import{P as E}from"./pen-BkgkWs_X.js";import{B as D}from"./briefcase-BqZwuGBh.js";import{C as v}from"./check-BZ1Mcvhg.js";import{D as j}from"./download-CzZr3cMn.js";/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w=y("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]),R=[{id:"rent",title:"Rent Agreement",icon:N,category:"Property",color:"text-blue-400",bg:"bg-blue-500/10 border-blue-500/20",desc:"Standard residential rent agreement between landlord and tenant.",fields:[{key:"landlordName",label:"Landlord's Full Name",placeholder:"Rajesh Kumar Sharma"},{key:"tenantName",label:"Tenant's Full Name",placeholder:"Amit Verma"},{key:"propertyAddress",label:"Property Address",placeholder:"C-42, Sector 15, Noida, UP 201301",multiline:!0},{key:"monthlyRent",label:"Monthly Rent (₹)",placeholder:"25000"},{key:"securityDeposit",label:"Security Deposit (₹)",placeholder:"50000"},{key:"startDate",label:"Lease Start Date",placeholder:"01/04/2026"},{key:"duration",label:"Lease Duration",placeholder:"11 months"}],template:t=>`RENT AGREEMENT
>>>>>>>> origin/main:artifacts/api-server/public/assets/ClientDIYDocs-B3FOtefz.js
...
[Note: This draft should be reviewed by an advocate and stamped on ₹500 stamp paper for legal validity]`},{id:"affidavit",title:"General Affidavit",icon:g,category:"Legal",color:"text-amber-400",bg:"bg-amber-500/10 border-amber-500/20",desc:"General purpose sworn statement / affidavit for official use.",fields:[{key:"deponentName",label:"Deponent's Full Name",placeholder:"Sunita Joshi"},{key:"deponentAge",label:"Age",placeholder:"35"},{key:"deponentAddress",label:"Address",placeholder:"B-12, Civil Lines, Delhi 110054",multiline:!0},{key:"purpose",label:"Purpose / Statement",placeholder:"I hereby declare that I am a resident of the above address since the year 2010 and the said property belongs to my family.",multiline:!0}],template:t=>`AFFIDAVIT
...
[Note: For stronger legal standing, send this notice through a registered advocate and by Registered Post / Speed Post with Acknowledgement Due]`},{id:"nda",title:"NDA / Non-Disclosure",icon:D,category:"Business",color:"text-violet-400",bg:"bg-violet-500/10 border-violet-500/20",desc:"Simple one-way non-disclosure agreement for business use.",fields:[{key:"disclosingParty",label:"Disclosing Party (You)",placeholder:"TechStartup Pvt. Ltd."},{key:"receivingParty",label:"Receiving Party",placeholder:"Rahul Sharma, Freelancer"},{key:"purpose",label:"Purpose of Disclosure",placeholder:"Evaluation of a potential business collaboration for mobile app development"},{key:"duration",label:"Confidentiality Period",placeholder:"2 years"}],template:t=>`NON-DISCLOSURE AGREEMENT
...
<<<<<<<< HEAD:artifacts/api-server/public/assets/ClientDIYDocs-BDgg7PH2.js
[Note: Have this reviewed by an advocate for complex business arrangements]`}];function O(){const[t,m]=n.useState(null),[i,d]=n.useState({}),[s,c]=n.useState(null),[h,_]=n.useState(!1),f=()=>{if(!t)return;const a=t.template(i);c(a)},x=()=>{s&&(navigator.clipboard.writeText(s),_(!0),setTimeout(()=>_(!1),2e3))},y=()=>{if(!s||!t)return;const a=new Blob([s],{type:"text/plain"}),o=URL.createObjectURL(a),r=document.createElement("a");r.href=o,r.download=`${t.title.replace(/\s+/g,"_")}_${Date.now()}.txt`,r.click(),URL.revokeObjectURL(o)};return e.jsxs("div",{className:"space-y-8",children:[e.jsxs(l.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},children:[e.jsxs("div",{className:"flex items-center gap-3 mb-1",children:[e.jsx(E,{className:"w-7 h-7 text-blue-400"}),e.jsx("h1",{className:"text-3xl font-serif font-bold text-[#1A2332]",children:"DIY Legal Documents"})]}),e.jsx("p",{className:"text-[#1A2332]/40 ml-10",children:"Draft basic legal documents yourself — instantly, for free."})]}),e.jsxs("div",{className:"bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-4 flex items-start gap-3",children:[e.jsx(u,{className:"w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5"}),e.jsx("p",{className:"text-[#1A2332]/60 text-sm leading-relaxed",children:"These templates are a starting point. For important matters, always have a qualified advocate review the document before signing or filing."})]}),t?e.jsxs(l.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsx("button",{onClick:()=>{m(null),c(null)},className:"flex items-center gap-2 text-[#1A2332]/40 hover:text-[#1A2332] text-sm mb-6 transition-colors",children:"← Back to Documents"}),e.jsx("div",{className:`border rounded-2xl p-5 mb-6 ${t.bg}`,children:e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(t.icon,{className:`w-7 h-7 ${t.color}`}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-[#1A2332] font-bold text-lg",children:t.title}),e.jsx("p",{className:"text-[#1A2332]/40 text-xs",children:t.desc})]})]})}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:t.fields.map(a=>e.jsxs("div",{className:a.multiline?"sm:col-span-2":"",children:[e.jsx("label",{className:"block text-[#1A2332]/60 text-xs font-semibold uppercase tracking-wider mb-2",children:a.label}),a.multiline?e.jsx("textarea",{value:i[a.key]||"",onChange:o=>d(r=>({...r,[a.key]:o.target.value})),placeholder:a.placeholder,rows:3,className:"w-full bg-card/40 border border-[#1A2332]/10 rounded-xl px-4 py-3 text-[#1A2332] text-sm placeholder:text-[#1A2332]/25 focus:outline-none focus:border-blue-500/40 resize-none"}):e.jsx("input",{value:i[a.key]||"",onChange:o=>d(r=>({...r,[a.key]:o.target.value})),placeholder:a.placeholder,className:"w-full bg-card/40 border border-[#1A2332]/10 rounded-xl px-4 py-3 text-[#1A2332] text-sm placeholder:text-[#1A2332]/25 focus:outline-none focus:border-blue-500/40"})]},a.key))}),e.jsxs("button",{onClick:f,className:"w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-[#1A2332] py-4 rounded-xl font-bold text-base transition-all hover:shadow-lg hover:shadow-blue-500/30 mb-6",children:[e.jsx(T,{className:"w-5 h-5"}),"Generate Document"]}),s&&e.jsxs(l.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsx("h3",{className:"text-[#1A2332] font-semibold",children:"Your Document is Ready"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("button",{onClick:x,className:"flex items-center gap-1.5 bg-[#1A2332]/10 hover:bg-[#1A2332]/20 text-[#1A2332]/60 hover:text-[#1A2332] px-3 py-2 rounded-xl text-xs font-bold transition-all border border-[#1A2332]/10",children:[h?e.jsx(u,{className:"w-3.5 h-3.5 text-emerald-400"}):e.jsx(v,{className:"w-3.5 h-3.5"}),h?"Copied!":"Copy"]}),e.jsxs("button",{onClick:y,className:"flex items-center gap-1.5 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 border border-blue-500/30 px-3 py-2 rounded-xl text-xs font-bold transition-all",children:[e.jsx(j,{className:"w-3.5 h-3.5"}),"Download"]})]})]}),e.jsx("pre",{className:"bg-card/40 border border-[#1A2332]/10 rounded-2xl p-5 text-[#1A2332]/80 text-xs leading-relaxed whitespace-pre-wrap font-mono max-h-96 overflow-y-auto",children:s}),e.jsx("div",{className:"mt-4 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl",children:e.jsxs("p",{className:"text-amber-400 text-xs flex items-start gap-2",children:[e.jsx(b,{className:"w-4 h-4 flex-shrink-0 mt-0.5"}),"Review this draft carefully and have it checked by a qualified advocate before signing, notarizing, or filing it."]})})]})]}):e.jsxs("div",{children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-[#1A2332]/40 mb-4",children:"Choose a Document"}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:R.map((a,o)=>e.jsx(l.div,{initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{delay:.08*o},onClick:()=>{m(a),d({}),c(null)},className:`border rounded-2xl p-5 cursor-pointer hover:-translate-y-1 transition-all duration-300 group ${a.bg}`,children:e.jsxs("div",{className:"flex items-start gap-4",children:[e.jsx(a.icon,{className:`w-8 h-8 ${a.color} flex-shrink-0`}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsx("h3",{className:"text-[#1A2332] font-bold",children:a.title}),e.jsx("span",{className:"text-[10px] text-[#1A2332]/30 bg-[#1A2332]/5 px-2 py-0.5 rounded-full border border-[#1A2332]/10",children:a.category})]}),e.jsx("p",{className:"text-[#1A2332]/50 text-sm",children:a.desc}),e.jsxs("div",{className:`flex items-center gap-1.5 mt-3 text-sm font-bold ${a.color} group-hover:gap-2 transition-all`,children:["Create Draft ",e.jsx(A,{className:"w-4 h-4"})]})]})]})},a.id))}),e.jsxs("div",{className:"mt-6 p-5 bg-card/30 border border-[#1A2332]/10 rounded-2xl text-center",children:[e.jsx("p",{className:"text-[#1A2332]/40 text-sm mb-3",children:"Need a custom document or something more complex?"}),e.jsxs("div",{className:"flex justify-center gap-3",children:[e.jsx(p,{href:"/client/ai-assistant",children:e.jsx("button",{className:"flex items-center gap-2 bg-blue-500/20 text-blue-400 border border-blue-500/30 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-blue-500/30 transition-all",children:"Ask AI Assistant"})}),e.jsx(p,{href:"/client/book",children:e.jsx("button",{className:"flex items-center gap-2 bg-[#1A2332]/10 text-[#1A2332] border border-[#1A2332]/10 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-[#1A2332]/20 transition-all",children:"Book an Advocate"})})]})]})]})]})}export{O as ClientDIYDocs};
========
[Note: Have this reviewed by an advocate for complex business arrangements]`}];function O(){const[t,h]=s.useState(null),[i,d]=s.useState({}),[n,c]=s.useState(null),[_,p]=s.useState(!1),u=()=>{if(!t)return;const a=t.template(i);c(a)},f=()=>{n&&(navigator.clipboard.writeText(n),p(!0),setTimeout(()=>p(!1),2e3))},x=()=>{if(!n||!t)return;const a=new Blob([n],{type:"text/plain"}),o=URL.createObjectURL(a),r=document.createElement("a");r.href=o,r.download=`${t.title.replace(/\s+/g,"_")}_${Date.now()}.txt`,r.click(),URL.revokeObjectURL(o)};return e.jsxs("div",{className:"space-y-8",children:[e.jsxs(l.div,{initial:{opacity:0,y:-10},animate:{opacity:1,y:0},children:[e.jsxs("div",{className:"flex items-center gap-3 mb-1",children:[e.jsx(E,{className:"w-7 h-7 text-blue-400"}),e.jsx("h1",{className:"text-3xl font-serif font-bold text-[#1A2332]",children:"DIY Legal Documents"})]}),e.jsx("p",{className:"text-[#1A2332]/40 ml-10",children:"Draft basic legal documents yourself — instantly, for free."})]}),e.jsxs("div",{className:"bg-amber-500/10 border border-amber-500/25 rounded-2xl p-4 flex items-start gap-3",children:[e.jsx(m,{className:"w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5"}),e.jsx("p",{className:"text-[#1A2332]/70 text-sm leading-relaxed",children:"Template preview only — not filed, not notarized, and not Legal Connect-supervised advice. Have a verified advocate review before signing or filing."})]}),t?e.jsxs(l.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsx("button",{onClick:()=>{h(null),c(null)},className:"flex items-center gap-2 text-[#1A2332]/40 hover:text-[#1A2332] text-sm mb-6 transition-colors",children:"← Back to Documents"}),e.jsx("div",{className:`border rounded-2xl p-5 mb-6 ${t.bg}`,children:e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(t.icon,{className:`w-7 h-7 ${t.color}`}),e.jsxs("div",{children:[e.jsx("h2",{className:"text-[#1A2332] font-bold text-lg",children:t.title}),e.jsx("p",{className:"text-[#1A2332]/40 text-xs",children:t.desc})]})]})}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6",children:t.fields.map(a=>e.jsxs("div",{className:a.multiline?"sm:col-span-2":"",children:[e.jsx("label",{className:"block text-[#1A2332]/60 text-xs font-semibold uppercase tracking-wider mb-2",children:a.label}),a.multiline?e.jsx("textarea",{value:i[a.key]||"",onChange:o=>d(r=>({...r,[a.key]:o.target.value})),placeholder:a.placeholder,rows:3,className:"w-full bg-card/40 border border-[#1A2332]/10 rounded-xl px-4 py-3 text-[#1A2332] text-sm placeholder:text-[#1A2332]/25 focus:outline-none focus:border-blue-500/40 resize-none"}):e.jsx("input",{value:i[a.key]||"",onChange:o=>d(r=>({...r,[a.key]:o.target.value})),placeholder:a.placeholder,className:"w-full bg-card/40 border border-[#1A2332]/10 rounded-xl px-4 py-3 text-[#1A2332] text-sm placeholder:text-[#1A2332]/25 focus:outline-none focus:border-blue-500/40"})]},a.key))}),e.jsxs("button",{onClick:u,className:"w-full flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-[#1A2332] py-4 rounded-xl font-bold text-base transition-all hover:shadow-lg hover:shadow-blue-500/30 mb-6",children:[e.jsx(T,{className:"w-5 h-5"}),"Generate Document"]}),n&&e.jsxs(l.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsx("h3",{className:"text-[#1A2332] font-semibold",children:"Your Document is Ready"}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs("button",{onClick:f,className:"flex items-center gap-1.5 bg-[#1A2332]/10 hover:bg-[#1A2332]/20 text-[#1A2332]/60 hover:text-[#1A2332] px-3 py-2 rounded-xl text-xs font-bold transition-all border border-[#1A2332]/10",children:[_?e.jsx(v,{className:"w-3.5 h-3.5 text-emerald-400"}):e.jsx(w,{className:"w-3.5 h-3.5"}),_?"Copied!":"Copy"]}),e.jsxs("button",{onClick:x,className:"flex items-center gap-1.5 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 border border-blue-500/30 px-3 py-2 rounded-xl text-xs font-bold transition-all",children:[e.jsx(j,{className:"w-3.5 h-3.5"}),"Download"]})]})]}),e.jsx("pre",{className:"bg-card/40 border border-[#1A2332]/10 rounded-2xl p-5 text-[#1A2332]/80 text-xs leading-relaxed whitespace-pre-wrap font-mono max-h-96 overflow-y-auto",children:n}),e.jsx("div",{className:"mt-4 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl",children:e.jsxs("p",{className:"text-amber-400 text-xs flex items-start gap-2",children:[e.jsx(m,{className:"w-4 h-4 flex-shrink-0 mt-0.5"}),"Review this draft carefully and have it checked by a qualified advocate before signing, notarizing, or filing it."]})})]})]}):e.jsxs("div",{children:[e.jsx("h2",{className:"text-xs font-semibold uppercase tracking-widest text-[#1A2332]/40 mb-4",children:"Choose a Document"}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 gap-4",children:R.map((a,o)=>e.jsx(l.div,{initial:{opacity:0,y:15},animate:{opacity:1,y:0},transition:{delay:.08*o},onClick:()=>{h(a),d({}),c(null)},className:`border rounded-2xl p-5 cursor-pointer hover:-translate-y-1 transition-all duration-300 group ${a.bg}`,children:e.jsxs("div",{className:"flex items-start gap-4",children:[e.jsx(a.icon,{className:`w-8 h-8 ${a.color} flex-shrink-0`}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsx("h3",{className:"text-[#1A2332] font-bold",children:a.title}),e.jsx("span",{className:"text-[10px] text-[#1A2332]/30 bg-[#1A2332]/5 px-2 py-0.5 rounded-full border border-[#1A2332]/10",children:a.category})]}),e.jsx("p",{className:"text-[#1A2332]/50 text-sm",children:a.desc}),e.jsxs("div",{className:`flex items-center gap-1.5 mt-3 text-sm font-bold ${a.color} group-hover:gap-2 transition-all`,children:["Create Draft ",e.jsx(A,{className:"w-4 h-4"})]})]})]})},a.id))}),e.jsxs("div",{className:"mt-6 p-5 bg-card/30 border border-[#1A2332]/10 rounded-2xl text-center",children:[e.jsx("p",{className:"text-[#1A2332]/40 text-sm mb-3",children:"Need a custom document or something more complex?"}),e.jsxs("div",{className:"flex justify-center gap-3",children:[e.jsx(b,{href:"/client/book",children:e.jsx("button",{className:"flex items-center gap-2 bg-[#1A2332]/10 text-[#1A2332] border border-[#1A2332]/10 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-[#1A2332]/20 transition-all",children:"Submit an intake"})}),e.jsx(b,{href:"/client/lawbot",children:e.jsx("button",{className:"flex items-center gap-2 bg-[#D4A050]/15 text-[#8A5A13] border border-[#D4A050]/30 px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-[#D4A050]/25 transition-all",children:"Ask LawBot"})})]})]})]})]})}export{O as ClientDIYDocs};
>>>>>>>> origin/main:artifacts/api-server/public/assets/ClientDIYDocs-B3FOtefz.js
